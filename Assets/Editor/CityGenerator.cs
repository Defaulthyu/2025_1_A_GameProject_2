...
public class CityGenerator : EditorWindow           //유니티 에디터
{
    ...
    private void OnGUI()
    {
        ...
        buildingSpacing = EditorGUILayout.FloatField("Road Width" , roadWidth); //도로 폭 입력
    ...
    private void GenerateCity()
    {
        ...
        GameObject roadsParent = new GameObject("Roads");        //건물 묶은 부모
