...
public class EffectManager : MonoBehaviour
{
    ...
    public class EffectData
    {
        ...
        public float defaultDuration = 2f;  //기본 지속시간
    }
    [Header("이펙트 목록")]
    ...
    public GameObject PlayEffect(string effectName, Vector3 position, Quaternion rotation)      //이펙트 재생 기본 힘
    {
    ...
    public GameObject PlayEffect(string effectName, Vector3 position, float duration)   //이펙트 재생 (지속시간 설정)
    {
